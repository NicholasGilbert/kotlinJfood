...
class CashInvoice : Invoice{
    ...
    constructor(id: Int, food: Food, date: String, customer: Customer, status: InvoiceStatus): super (id, food, date, customer, PaymentType.Cash, status){
        setTotalPrice()
        showNoDelivery()
    }
    constructor(id: Int, food: Food, date: String, customer: Customer, status: InvoiceStatus, delivery: Int): super (id, food, date, customer, PaymentType.Cash, status){
