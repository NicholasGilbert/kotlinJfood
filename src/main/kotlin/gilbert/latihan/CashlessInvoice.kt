...
class CashlessInvoice : Invoice {
    ...
    constructor(id: Int, food: Food, date: String, customer: Customer, status: InvoiceStatus): super (id, food, date, customer, PaymentType.Cashless, status){
        setTotalPrice()
        showNoPromo()
    }
    constructor(id: Int, food: Food, date: String, customer: Customer, status: InvoiceStatus, promo: Promo): super (id, food, date, customer, PaymentType.Cashless, status){
